...
public class BrugerRepo {
    ...
    public void addBruger(Bruger A) {
        String sql = "INSERT INTO bruger(fornavn,efternavn,brugernavn,bruger_email)VALUES(?,?,?,?)";
        template.update(sql,A.getFornavn(), A.getEfternavn(), A.getBrugernavn(), A.getBruger_email());
