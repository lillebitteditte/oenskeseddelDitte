...
public class HomeController {
    ...
    @PostMapping("/opdaterØnske")
    public String opdaterØnske(@ModelAttribute Ønske ønske){
        ønskeService.opdaterØnske(ønske.getBruger_id(),ønske);
        return "redirect:/";
    }
